...
# Step 3: Codex CLI
STR_CODEX_TITLE="Do you use OpenAI Codex CLI for task delegation?"
...
STR_HOOKS_CHECK_CODEX_AFTER_PLAN="Codex After Plan - Suggest design review when plan files change"
STR_HOOKS_CHECK_CODEX_BEFORE_WRITE="Codex Write Counter - Suggest design review after every 5 file writes"
STR_HOOKS_ERROR_TO_CODEX="Error to Codex - Suggest Codex debugging when commands fail"
...
STR_CODEX_SETUP_TITLE="Codex CLI Setup"
STR_CODEX_SETUP_NOTE="Note: Codex CLI requires installation and authentication (ChatGPT sign-in or OpenAI API key)"
...
STR_CODEX_RESTART_HINT="If Claude Code is already running, restart to pick up Codex CLI changes"
STR_CODEX_SETUP_DONE="Codex CLI setup complete"
STR_CODEX_SETUP_INCOMPLETE="Codex CLI setup is not complete yet. Finish the remaining steps later"
STR_CODEX_SETUP_CONFIRM="Start Codex CLI setup? (CLI install + authentication)"
...
STR_EXISTING_CLAUDE_SIDE_EFFECTS="Optional side effects like shell RC updates or Codex CLI setup may also run depending on your selections."
