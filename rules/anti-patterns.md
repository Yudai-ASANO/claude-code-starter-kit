...
- If you think something additional is needed, ASK first - do not implement it.
...
- When reading errors, extract the relevant information and don't keep full stack traces in context.
